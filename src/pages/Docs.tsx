...
{`export Qualifyr.AI_API_KEY="ps_live_your_api_key_here"`}
                    </pre>
                  </CardContent>
                </Card>
              </div>
...
{`curl -X POST https://api.Qualifyr.AI.com/v1/parse \\
  -H "Authorization: Bearer $Qualifyr.AI_API_KEY" \\
...
url = "https://api.Qualifyr.AI.com/v1/parse"
...
const url = "https://api.Qualifyr.AI.com/v1/parse";
                ...
                <Tabs defaultValue="curl" className="w-full">
                  ...
                  <TabsContent value="curl">
                    <Card className="bg-code">
                      <CardContent className="p-4">
                        <pre className="text-sm font-mono text-code-foreground overflow-x-auto">
{`curl -X POST https://api.Qualifyr.AI.com/v1/score \\
  -H "Authorization: Bearer $Qualifyr.AI_API_KEY" \\
...
response = requests.post(
    "https://api.Qualifyr.AI.com/v1/score",
    headers=headers,
    json=payload
)
